...
#define MI_DISPLAY_X_SIZE_DESC        94
#define MI_DISPLAY_Y_SIZE_DESC        56
...
static unsigned char HID_TouchReportDescriptor[] =
{
	...
	0x09, 0x30,        //     Usage (X)
	0x35, 0x00,        //     Physical Minimum (0)
	0x46, (MI_DISPLAY_X_SIZE_DESC&0xff), ((MI_DISPLAY_X_SIZE_DESC >> 8)&0xff),  //     Physical Maximum (94)
	0x81, 0x02,        //     Input (Data,Var,Abs,No Wrap,Linear,Preferred State,No Null Position)
	0x09, 0x31,        //     Usage (Y)
	0x26, (TOUCH_PAD_Y_SIZE_DESC&0xff), ((TOUCH_PAD_Y_SIZE_DESC>>8)&0xff),  //     Logical Maximum (1884)
	0x46, (MI_DISPLAY_Y_SIZE_DESC&0xff), ((MI_DISPLAY_Y_SIZE_DESC >> 8)&0xff),  //     Physical Maximum (56)
	0x81, 0x02,        //     Input (Data,Var,Abs,No Wrap,Linear,Preferred State,No Null Position)
	0xC0,              //   End Collection
	//-----------------------------------------------
	0xA1, 0x02,        //   Collection (Logical)
